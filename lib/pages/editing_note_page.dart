...
class EditingNotePge extends StatefulWidget {
  Note note;
  bool isNewNote;
  EditingNotePge({
    super.key, 
  ...
  @override
  State<EditingNotePge> createState() => _EditingNotePgeState();
}

class _EditingNotePgeState extends State<EditingNotePge> {
